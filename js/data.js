...
const GEAR_BREAKPOINTS = {
  melee: [
    ...
    // --- endgame melee ---
    { lvl: 75, item: 'Abyssal tentacle',   slot: 'weapon', notes: '75 Att — whip + Kraken tentacle' },
    { lvl: 80, item: 'Ghrazi rapier / Blade of Saeldor / Inquisitor\'s mace', slot: 'weapon', notes: '80 Att — BIS stab/slash' },
    { lvl: 82, item: 'Soulreaper axe',     slot: 'weapon', where: 'DT2 bosses', notes: '82 Att — stacking max hit' },
    { lvl: 55, item: 'Neitiznot faceguard', slot: 'head', where: 'Fremennik Hard diary', notes: '+str' },
    { lvl: 70, item: "Inquisitor's helm / Justiciar faceguard", slot: 'head', notes: '70 Def — Nightmare/ToB' },
    { lvl: 80, item: 'Torva full helm',    slot: 'head', where: 'Nex', notes: '80 Def — BIS melee' },
    { lvl: 60, item: 'Fighter torso / Bandos chestplate', slot: 'body', notes: 'Fighter torso (BA) cheap top str body; Bandos at GWD' },
    { lvl: 80, item: 'Torva platebody',    slot: 'body', where: 'Nex', notes: '80 Def — BIS melee' },
    { lvl: 60, item: 'Bandos tassets',     slot: 'legs', where: 'GWD', notes: 'BIS-tier melee legs' },
    { lvl: 80, item: 'Torva platelegs',    slot: 'legs', where: 'Nex', notes: '80 Def — BIS melee' },
    { lvl: 75, item: 'Primordial boots',   slot: 'boots', where: 'Cerberus', notes: '75 Def — BIS-tier' },
    { lvl: 85, item: 'Avernic treads',     slot: 'boots', where: 'Doom of Mokhaiotl', notes: 'newest BIS melee boots' },
    { lvl: 75, item: 'Amulet of torture',  slot: 'amulet', notes: 'zenyte — BIS-tier melee neck' },
    { lvl: 80, item: 'Amulet of rancour',  slot: 'amulet', where: 'Araxxor', notes: 'newest BIS melee neck' },
    { lvl: 60, item: 'Fire cape',          slot: 'cape', where: 'Fight Cave', notes: '+4 str' },
    { lvl: 80, item: 'Infernal cape',      slot: 'cape', where: 'Inferno', notes: 'BIS, +4 str' },
    { lvl: 1,  item: 'Barrows gloves',     slot: 'gloves', where: 'Recipe for Disaster', notes: 'BIS gloves until Ferocious' },
    { lvl: 80, item: 'Ferocious gloves',   slot: 'gloves', where: 'Alchemical Hydra', notes: '80 Att — BIS melee gloves' },
    { lvl: 60, item: 'Berserker ring (i)', slot: 'ring', where: 'DKs (imbue at NMZ)' },
    { lvl: 90, item: 'Ultor ring',         slot: 'ring', where: 'DT2', notes: 'BIS melee ring' },
  ],
  ...
  ranged: [
    ...
    // --- endgame ranged ---
    { lvl: 80, item: 'Bow of Faerdhinen / Armadyl crossbow', slot: 'weapon', notes: '80 Ranged — best non-raid' },
    { lvl: 85, item: 'Twisted bow',        slot: 'weapon', where: 'CoX', notes: 'BIS ranged weapon' },
    { lvl: 73, item: 'Armadyl helmet / Crystal helm', slot: 'head', notes: '70+ Ranged' },
    { lvl: 80, item: 'Masori mask (f)',    slot: 'head', where: 'ToA', notes: 'BIS ranged' },
    { lvl: 70, item: 'Armadyl chestplate', slot: 'body', where: 'GWD', notes: 'BIS-tier' },
    { lvl: 80, item: 'Masori body (f)',    slot: 'body', where: 'ToA', notes: 'BIS ranged armour' },
    { lvl: 70, item: 'Armadyl chainskirt', slot: 'legs', where: 'GWD' },
    { lvl: 80, item: 'Masori chaps (f)',   slot: 'legs', where: 'ToA' },
    { lvl: 75, item: 'Pegasian boots',     slot: 'boots', where: 'Cerberus', notes: 'BIS ranged boots' },
    { lvl: 75, item: 'Necklace of anguish', slot: 'amulet', notes: 'zenyte — BIS ranged neck' },
    { lvl: 75, item: 'Barrows gloves',     slot: 'gloves', where: 'RFD', notes: 'until Zaryte' },
    { lvl: 80, item: 'Zaryte vambraces',   slot: 'gloves', where: 'Nex', notes: 'BIS ranged gloves' },
    { lvl: 60, item: 'Archer ring (i)',    slot: 'ring', where: 'DKs (imbue)' },
    { lvl: 90, item: 'Venator ring',       slot: 'ring', where: 'DT2', notes: 'BIS ranged ring' },
    { lvl: 60, item: "Ava's Assembler",    slot: 'cape', where: 'Vorkath head + Accumulator', notes: 'BIS ranged cape' },
  ],
  ...
  magic: [
    ...
    // --- endgame magic ---
    { lvl: 75, item: 'Trident of the swamp / Sanguinesti staff', slot: 'weapon', notes: 'Sang from ToB' },
    { lvl: 82, item: "Tumeken's shadow",     slot: 'weapon', where: 'ToA', notes: 'BIS magic weapon' },
    { lvl: 70, item: 'Ahrim\'s hood / Virtus mask', slot: 'head', notes: 'Virtus from DT2' },
    { lvl: 75, item: 'Ancestral hat',        slot: 'head', where: 'CoX', notes: 'BIS' },
    { lvl: 75, item: 'Ancestral robe top',   slot: 'body', where: 'CoX', notes: 'BIS mage armour' },
    { lvl: 75, item: 'Ancestral robe bottom', slot: 'legs', where: 'CoX' },
    { lvl: 75, item: 'Eternal boots',        slot: 'boots', where: 'Cerberus', notes: 'BIS mage boots' },
    { lvl: 75, item: 'Occult necklace',      slot: 'amulet', where: 'Thermo', notes: '+10% magic dmg' },
    { lvl: 75, item: 'Tormented bracelet',   slot: 'gloves', notes: 'zenyte — BIS mage wrist' },
    { lvl: 70, item: 'Imbued god cape',      slot: 'cape', where: 'Mage Arena 2', notes: 'BIS mage cape' },
    { lvl: 75, item: 'Seers ring (i)',       slot: 'ring', where: 'DKs (imbue)' },
    { lvl: 90, item: 'Magus ring',           slot: 'ring', where: 'DT2', notes: 'BIS magic ring' },
  ],
};
